...
var Motu={
	...
	Exhibition : function(type){
		...
		case 2: //双挂角交互
		  ...
		  break;
		case 3: //单挂角展示
		  Motu.addClassSingleShow(option.pointId)
		  break;
		case 4: //长底栏交互
	...
	addClassSingleShow : function(pointId){
		$(pointId+ ':first').parent("p").css({"position":"relative"})
		// alert(pointId)
