...
var Motu={
	...
	Exhibition : function(type){
		...
		case 1: //单挂角交互
		  // 执行代码块 1
		  Motu.addClassSingle(option.pointId,option.mediaId)
		  break;
		case 2: //双挂角交互
	...
	addClassSingle : function(pointId,mediaId){
		if(mediaId==99){
		...
		// loadCss(option.csss)
		//对应背景图案设置
		$(".mMhAd").css({"background":"url(./single/single1.jpg)"})
		//小图曝光监测
		...
		$(".mMBPic").css({"background":"url(./single/single2.jpg)"})
		Motu.wz(option);
